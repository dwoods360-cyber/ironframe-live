...
documentId: "GF-STANDARDS-001"
title: "Governance Frame Editorial Standards"
...
- [`operating-outline.md`](./operating-outline.md) — roles, tools, and cadence
...
1. **Documented fact** — directly supported by evidence.
2. **Analytical interpretation** — Governance Frame’s reasoned conclusion.
3. **Illustrative example** — hypothetical or simplified scenario.
4. **Architectural recommendation** — a possible governance or control response.
5. **Product relevance** — how a named product may implement part of the recommendation.
6. **Unresolved research question** — an issue not yet answered by sufficient evidence.
