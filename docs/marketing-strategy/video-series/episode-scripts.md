---
Document Type: Marketing Scripts
Status: REDIRECT
Series: When Risk Enters the Room
Last Updated: 2026-08-04
---

# Episode scripts — index

Full scene-by-scene scripts are separate files in this folder:
...
Campaign hub (plan + full narrative index): [when-risk-enters-the-room.md](./when-risk-enters-the-room.md)
