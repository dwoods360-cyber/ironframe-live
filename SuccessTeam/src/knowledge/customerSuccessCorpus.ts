...
export const CUSTOMER_SUCCESS_KNOWLEDGE_CORPUS: Record<string, CustomerSuccessKnowledgeEntry> = {
  ...
  design_partner_path_b_onboarding: {
    ...
    keyTactics: [
      ...
      'By day 90: convert with Path B fee credited to year-1 Command (fixed convert credit, not a negotiated %) or clean exit — Path B fee non-refundable. Advocacy only after documented export/outcome.',
    ],
