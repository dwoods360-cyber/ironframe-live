...
/**
 * Dumb holder — presentation only; all ingestion/scoring runs in services (RSC + actions).
 */
export default function RiskCard({ processedData, stackIndex = 0, compact = false }: RiskCardProps) {
  const {
    title,
    value,
    delta,
