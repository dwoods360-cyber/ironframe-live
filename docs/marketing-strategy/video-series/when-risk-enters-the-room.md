...
|--------|---------|----------------|
| 7/28–8/01 | **V1 — The Risk Register** (*The Number*) generate + select | See publish windows |
| 8/04–8/08 | **V2 — The Audit Request** (*The Evidence*) generate + select | See publish windows |
...
| Window | Project | Publish target |
|--------|---------|----------------|
| 8/18–8/22 | **V3 — The Wrong Client** (*The Boundary*) | See publish windows |
| 8/25–8/29 | **V4 — The AI-Generated Board Report** (*The Draft*) | See publish windows |
| 9/01–9/05 | **V5 — The Connector** (*The Intake*) | See publish windows |
...
| Window | Project | Publish target |
|--------|---------|----------------|
| 9/15–9/26 | **V6 — The Complete Ironframe Story** (2–3 min) | See publish windows |
| 9/29–10/03 | Cutdowns, captions, product-page embed, Trust/solutions CTAs | — |

### Phase / budget summary

| Phase | Dates | Projects | Budget |
|-------|-------|----------|--------|
| 0 Style lock | 2026-07-21 → 07-25 | Character refs, boardroom, title/end cards, shot lists | Included in Phase 1 |
| 1 Episodes 1–2 | 2026-07-28 → 08-14 | V1 The Risk Register · V2 The Audit Request | **~$200** (Flow/Runway) |
| 2 Episodes 3–5 | 2026-08-18 → 09-12 | V3 Boundary · V4 Draft · V5 Intake | Remainder of **$300–$500** |
| 3 Main film | 2026-09-15 → 10-03 | V6 Complete Ironframe Story (2–3 min) | Included |

## Publish windows (rescheduled 2026-08-04)

Intervals preserved; no cross-list overlaps. Authoritative public ship dates:

| Date (UTC) | Asset | Channel |
|------------|-------|---------|
| Fri 2026-08-21 16:00 | V1 — The Number | LinkedIn + `/marketing` embed |
| Fri 2026-08-28 16:00 | V2 — The Evidence | LinkedIn + `/product-demo` CTA |
| Fri 2026-09-11 16:00 | V3 — The Boundary | LinkedIn + `/solutions/enterprise` |
| Fri 2026-09-18 16:00 | V4 — The Draft | LinkedIn + `/solutions/enterprise` |
| Fri 2026-09-25 16:00 | V5 — The Intake | LinkedIn + Irongate narrative |
| Fri 2026-10-16 16:00 | V6 — Complete story | LinkedIn + homepage + newsletter |
...
- [ ] StoryBrand problem-first cold open
- [ ] No forbidden claims (SOC 2 certified, invented customers, demo tenants as customers)
- [ ] Whole-cents / assumptions language accurate
- [ ] CTA = workflow review
...
Ops already sends **T-3 / T-2 / T-1 / T-0** reminders against each activity `dueAt`. This markdown is the production plan — it does not drive reminders.
