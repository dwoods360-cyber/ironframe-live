...
print("Restoring ArtifactDrawer.tsx and EditArtifactModal.tsx to STANDARD (Clean) state...")

# ---------------------------------------------------------
# 1. ArtifactDrawer.tsx (Standard / No Notes / No Expand)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# 2. EditArtifactModal.tsx (Standard / No Notes / No Backdate)
# ---------------------------------------------------------
