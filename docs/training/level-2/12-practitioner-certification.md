...
1. Complete practitioner reading order from LEVEL2 index
2. Execute architecture + deployment + TAS review
3. Pass manual testing protocol checkpoints
4. Submit practitioner attestation with route manifest citation
...
Cross-reference `docs/qa/complete-feature-glossary.md` for CERT-L2 before submitting the lab.
...
- [ ] CERT-L2 — procedure completed and screenshot archived
...
- source-file: docs/training/LEVEL2-PRACTITIONER-INDEX.md
...
ref: config/training-corpus-manifest.json · slug=training/level-2/12-practitioner-certification