...
export default function MetaAuditConsole({ tenantId, canAccess }: Props) {
  ...
  if (!canAccess) {
    return (
      <div className="rounded border border-zinc-800/80 bg-zinc-950/60 p-3">
        <p className="text-[10px] text-zinc-500">Meta-Audit Console requires AUDITOR or GLOBAL_ADMIN role.</p>
      </div>
    );
  }
