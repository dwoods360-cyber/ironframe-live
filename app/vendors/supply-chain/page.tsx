    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 p-6 text-slate-100">
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Link
            href="/vendors"
            className="inline-flex items-center gap-2 rounded border border-slate-700 bg-slate-900 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-300 hover:border-slate-500"
          >
            <ArrowLeft size={14} />
            Vendor Registry
          </Link>
