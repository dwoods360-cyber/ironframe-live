# 📋 Student Web Sandbox: How to Test the App
## Step-by-Step Screen Check for 11th & 12th Grade Technical Labs

Welcome to the Student QA (Quality Assurance) Testing Guide! In the software world, a QA tester's job is to click through an app like a regular user to make sure nothing breaks and that the screen behaves exactly how it is supposed to.
