# Chapter 4 — Security Architecture & Compliance Controls

> **Track:** LEVEL_2 · **Author agent:** board-writer · **Release:** `v0.1.0-ga-epic17`
> **Target length:** ~1600 words · **Primary route:** `/audit`

## Learning objectives

After completing this chapter, you will be able to navigate to `/audit`, execute the prescribed task flow, and verify SEC-001 controls using tenant-scoped session context.
...
![Chapter 4 — Security Architecture & Compliance Controls](/docs/training/assets/level-2-04-security-compliance-controls.png)

*Figure: Chapter 4 — Security Architecture & Compliance Controls — captured at `/audit`. Asset path: `/docs/training/assets/level-2-04-security-compliance-controls.png`.*

source-file: public/docs/training/assets/level-2-04-security-compliance-controls.png
...
A: Use primary route `/audit`, follow the navigation path table in this chapter, and archive screenshot `level-2-04-security-compliance-controls.png`.
...
- [ ] SEC-001 — procedure completed and screenshot archived
