# Content Calendar — Marketing (Template)
...
(plan, scripts, publish windows, and checklist — single hub)
...
| Thu | Docs | Update [User Guide](../end-users/user-guide.md) highlight |
...
- Competitive comparison PDF (see [Competitive Analysis](../sales/competitive-analysis.md))
...
- [ ] CTA to demo or docs hub
- [ ] UTM tags for analytics

## Social sync

Social-specific cadence: [Social Content Calendar](../social/content-calendar.md)
