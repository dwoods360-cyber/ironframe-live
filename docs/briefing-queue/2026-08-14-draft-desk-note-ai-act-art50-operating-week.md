...
National competent authorities can now treat chatbot disclosure, synthetic-content marking (subject to the limited legacy transition commonly described through **2 December 2026** for machine-readable marking on generative systems already on the market before 2 August), and deployer deepfake / public-interest text labeling as present-tense controls. The failure mode is still category error: teams that only tracked deferred Annex III high-risk dates may lack provider/deployer inventories for Article 50 systems already in production.

Commission guidelines on Article 50 transparency (finalised mid/late July 2026) are the practical reading aid; they do not replace the regulation text.
