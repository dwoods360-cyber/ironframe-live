...
import { canUsePartnerProvisioner } from "@/app/lib/auth/partnerProvisionerAccess";
...
/** Edge-safe partner provisioner check for middleware (client onboarding console). */
export async function GET(req: NextRequest) {
  ...
  const allowed = await canUsePartnerProvisioner(userId, email);
